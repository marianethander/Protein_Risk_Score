...
#Maria Nethander, Bioinformatics Core Facility, Gothenburg
#2014-03-26


NRIcutoff<-function(basemodel,riskmodel,events,nonevents,cutoff){
...
predbase = as.numeric(predbase>=cutoff)
predrisk = as.numeric(predrisk>=cutoff)
